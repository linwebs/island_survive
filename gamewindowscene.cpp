...
void GameWindowScene::f_event() {
	...
	} else if(player->action->get_status() == 0 && map->get_local_item() == 9) {
		player->action->pick(9);
	} else if(player->action->get_status() == 0 && map->get_local_item() == 10) {
		player->action->pick(10);
	} else if(player->action->get_status() == 0 && map->get_local_item() == 8) {
